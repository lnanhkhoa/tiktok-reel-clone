...
const _RecordingButton: React.FC<Props> = ({
  camera,
  onMediaCaptured,
  minZoom,
  maxZoom,
  ...
  }, [camera, flash, isPressingButton, onMediaCaptured, onStoppedRecording]);
  //#endregion
...
export const RecordingButton = React.memo(_RecordingButton);
